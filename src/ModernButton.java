...
public class ModernButton extends JButton {
    ...
    public ModernButton(String text, Color defaultColor) {
        ...
        this.hoverColor = adjustColor(defaultColor, 20); // Brighter for hover in dark mode
        this.pressColor = adjustColor(defaultColor, -20);
        this.textColor = Color.white; // Use white text for better contrast in dark mode
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isEnabled()) {
            ...
            g2.setColor(new Color(60, 60, 60)); // Darker disabled color for dark mode
        }
        ...
        g2.setColor(isEnabled() ? textColor : new Color(160, 160, 160)); // Lighter disabled text for visibility
        g2.setFont(getFont());
    ...
    public void setDefaultColor(Color color) {
        ...
        this.hoverColor = adjustColor(color, 20); // Brighter for hover in dark mode
